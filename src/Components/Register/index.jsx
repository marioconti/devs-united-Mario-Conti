...
export const Register = () => {
  ...
  const handlePickColor = (e) => {
    ...
    console.log(e.nativeEvent.path[0].attributes.color.value);
  };
  console.log(nameUser);
  const handleSendRegister = async () => {
    await updateData("users", uid, { name: nameUser, color: favoriteColor });
    clearNameUser();
  };
        ...
        <div className="section-credentials">
          ...
          <div className="favorite-color">
            ...
            <button
              ...
              disabled={
                nameUser.length > 0 && favoriteColor.length > 0 ? false : true
              }
            >
              CONTINUE
            </button>
